...
import org.productshop.repositoris.UserRepository;
...
public class UserServiceImpl implements UserService{
    ...
    public UserServiceModel registerUser(UserServiceModel userServiceModel) {
        ...
        if (this.userRepository.count() == 0){
            ...
            userServiceModel.getAuthorities().add(this.roleService
                    .findAuthority("ROLE_USER"));
        }
    ...
    public UserServiceModel editProfile(UserServiceModel userServiceModel, String oldPassword) {
        ...
        user.setPassword(!"".equals(userServiceModel.getPassword()) ?
                this.bCryptPasswordEncoder
                        .encode(userServiceModel.getPassword()): user.getPassword());
    ...
    public void setUserRole(String id, String role) {
     ...
     switch (role){
         case "user":
             userServiceModel.getAuthorities().add(this.roleService.findAuthority("ROLE_USER"));
             break;
         case "moderator":
             userServiceModel.getAuthorities().add(this.roleService.findAuthority("ROLE_USER"));
             userServiceModel.getAuthorities().add(this.roleService.findAuthority("ROLE_MODERATOR"));
             break;
         case "admin":
             userServiceModel.getAuthorities().add(this.roleService.findAuthority("ROLE_USER"));
             userServiceModel.getAuthorities().add(this.roleService.findAuthority("ROLE_MODERATOR"));
             userServiceModel.getAuthorities().add(this.roleService.findAuthority("ROLE_ADMIN"));
             break;
     }
